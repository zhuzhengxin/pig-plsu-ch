...
INSERT INTO `bill` VALUES (2, '明常市政', '朱正新', '刘先生', '大挖机', '2019-06-18', '1', '1', 1700, 250, 6.80);
INSERT INTO `bill` VALUES (3, '何家石油', '何先生', '朱正新', '油罐车', '2019-06-18', '0', '0', 31200, 6000, 5.20);
INSERT INTO `bill` VALUES (4, '明常市政', '朱正新', '朱先生', '小铲子', '2019-06-21', '1', '1', 2900, 500, 5.80);
INSERT INTO `bill` VALUES (5, '明常市政', '朱正新', '朱先生', '大挖机', '2019-06-21', '1', '1', 580, 100, 5.80);
INSERT INTO `bill` VALUES (6, '何家石油', '何先生', '朱先生', '油罐车', '2019-06-23', '0', '0', 26000, 5000, 5.20);
...
INSERT INTO `sys_dept` VALUES (10, '院校沙县', NULL, '2018-12-10 21:19:26', '0000-00-00 00:00:00', '0', 8);
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_dict` VALUES (7, '明常市政', '明常市政', 'mcsz', '明常市政', 0, NULL, NULL, '', '0');
...
INSERT INTO `sys_menu` VALUES (3000, '账单流水', NULL, '/bill', -1, 'icon-navicon-zdgl', 'views/admin/bill/index', 0, '0', '0', '2019-06-18 12:02:38', '2019-06-18 12:02:38', '0');
INSERT INTO `sys_menu` VALUES (3100, '新增', 'bill_add', NULL, 3000, NULL, NULL, 1, '0', '1', '2019-06-18 13:56:58', NULL, '0');
INSERT INTO `sys_menu` VALUES (3200, '删除', 'bill_del', NULL, 3000, NULL, NULL, 1, '0', '1', '2019-06-18 13:57:36', NULL, '0');
INSERT INTO `sys_menu` VALUES (3300, '修改', 'bill_edit', NULL, 3000, NULL, NULL, 1, '0', '1', '2019-06-18 13:58:08', NULL, '0');
...
CREATE TABLE `sys_role`  (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `del_flag` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '删除标识（0-正常,1-删除）',
  PRIMARY KEY (`role_id`) USING BTREE,
  UNIQUE INDEX `role_idx1_role_code`(`role_code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '系统角色表' ROW_FORMAT = Compact;
